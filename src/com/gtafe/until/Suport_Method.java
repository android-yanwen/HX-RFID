...
public class Suport_Method {
	...
	public SerialPort Choose_SerialPort(SharedPreferences sp, Editor editor,
			String device, String baudrate) {
		...
		editor.commit();
		// Log.d("SP","DEVICE="+sp.getString("DEVICE",
		// "none")+" BAUDRATE= "+sp.getString("BAUDRATE", "none"));
		try {
			mSerialPort = new SerialPort(new File(device),
					Integer.decode(baudrate), 0);
